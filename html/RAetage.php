...
<div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
          ...
          <div class="content-wrapper">
                    ...
                    <div class="card-body">
                      <form  method="post" action="./PHP/controllers/RAetage.php" >
                      <div class="mb-3">
                          <label class="form-label" for="basic-icon-default-fullname">etage</label>
                  ...
                  <table class="table">
                    ...
                    <?php 
                                    ...
                                    if(isset($etage)){
                                      ...
                                      $list=affectation::listAffectation_etage($etage);
                                     }else{
