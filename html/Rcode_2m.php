...
if(isset($_GET["code_2m"])){
  $code_2m=$_GET["code_2m"];
}
?>
...
<div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
          ...
          <div class="content-wrapper">
                    ...
                    <div class="card-body">
                      <form  method="post" action="./PHP/controllers/Rcode_2m.php" >
                        <div class="mb-3">
                          <label class="form-label" for="basic-icon-default-fullname">code 2M</label>
...
<hr class="my-5" />
              ...
              <div class="card">
                <h5 class="card-header">Code_2m</h5>
                  ...
                  <table class="table">
                    ...
                    <?php 
                                 if(isset($code_2m)){
                                  ...
                                  $list=Materiel::listMateriel_code_2m($code_2m);
                                 }else{
