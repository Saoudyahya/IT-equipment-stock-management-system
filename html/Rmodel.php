...
<div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
          ...
          <div class="content-wrapper">
                    ...
                    <div class="card-body">
                      <form  method="post" action="./PHP/controllers/Rmodel.php" >
                        <div class="mb-3">
                          <label class="form-label" for="basic-icon-default-fullname">model</label>
                  ...
                  <table class="table">
                    ...
                    <?php 
                                 if(isset($model)){
                                  ...
                                  $list=Materiel::listMateriel_model($model);
                                 }else{
