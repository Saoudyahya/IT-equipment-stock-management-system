...
<div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
          ...
          <div class="content-wrapper">
                    ...
                    <div class="card-body">
                      <form  method="post" action="./PHP/controllers/Rser.php" >
                        <div class="mb-3">
                          <label class="form-label" for="basic-icon-default-fullname">ser</label>
              ...
              <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <?php 
                                 if(isset($ser)){
                                  $list=Materiel::listMateriel_ser($ser);
                                 }else{
