...
if($_POST["departement"]){
  ...
  header("location: http://localhost/2m/html/affectation.php");
 };
 ...
 $user=user:: getDUser($departement);
?>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <form  method="post" action="./PHP/controllers/Caffectation.php" >
                      <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <select type="text" name="materiel"  class="form-control" id="exampleInputPassword1">
                                                              <option value="" disabled selected> choisir le materiel</option><?php foreach($materiels as $elm) { ?>
