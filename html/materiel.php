      ...
      <div class="layout-container">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">INSERSION/</span>Materiel</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form  method="post" action="./PHP/controllers/CMateriel.php" >
                        <div class="mb-3">
                  ...
                  <form  method="post" action="./PHP/controllers/Ccategorie.php">
                  <div class="mb-3">
