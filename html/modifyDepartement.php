              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">insertion/</span>users</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form  method="post" action="./PHP/classe/Mdepartement.php" >
                      
                        <div class="mb-3">
                      

                        
                          <label class="form-label" for="basic-icon-default-fullname">old departement name</label>
                        ...
                        <div class="mb-3">
                          ...
                          <label class="form-label" for="basic-icon-default-fullname">new departement name</label>
                          <div class="input-group input-group-merge">
                            <span id="basic-icon-default-fullname2" class="input-group-text"
                              ><i class="bx bx-user"></i
                            ></span>
