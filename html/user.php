              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">insertion/</span>users</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form  method="post" action="./PHP/controllers/Cuser.php" >
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <select type="text" name="departement"  class="form-control" id="exampleInputPassword1">
                                                              <option value="" disabled selected> choisir le dpartementl</option><?php foreach($C as$elm) { ?>
